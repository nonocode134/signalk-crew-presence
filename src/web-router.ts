...
export function createRouter(
  ...
  // Serve static files (index.html, icon.png, …) for the fallback route at
  // /plugins/signalk-crew-presence/ — Signal K intercepts the root without
  // trailing slash for its metadata endpoint, but subpaths are ours.
